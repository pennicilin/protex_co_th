...
class Article extends DataMapper {
	...
	var $created_field = 'created_date';
	var $updated_field = 'modified_date';
	var $default_order_by = array('sort' => 'asc');
	var $local_time = TRUE;
	// var $unix_timestamp = TRUE;

	var $has_one = array('category', 'section');
	...
	public function publish()
	{
		...
		return $this->where(array('is_deleted' => 0, 'is_published' => 1));
	}
